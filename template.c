...
// bulk set
#define setArr2(a, n) FOR3(i, 1, n) a[i] = i;
#define setArr3(a, n, v) FOR3(i, 1, n) a[i] = (v);
#define setArr4(a, n, m, v) FOR6(i, 1, n, j, 1, m) a[i][j] = (v);
#define setArr(...) VFUNC(setArr, __VA_ARGS__)
